...
comment_identifiers<-NA
for (com in 1:length(wfdocs_v)){
split <- strsplit(wfdocs_v[com], "%_%")
split <- unlist(split)
comment_identifiers[com] <- split
}
View(head(comment_identifiers))
...
wf_docdata.df <- data.frame(wfdocs_v, title, theta, alpha)
#View(wf_docdata.df)
