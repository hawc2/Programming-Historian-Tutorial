...
#remove videos with less than M comments and view final count
...
#Is this missing lines to remove punctuation?
...
#@ if you want to re-save visualizations with different parameters, you can change subject_s to be more specific
...
#setwd(paste(data.dir, vis.dir, subject.dir, sep="")) (currently throws error with data.dir)
getwd()
